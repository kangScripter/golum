...
$url = "https://api.telegram.org/bot1860781460:AAHOUPAWKur2BzMRfmLU1wIBedlm6GGGL8g/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
